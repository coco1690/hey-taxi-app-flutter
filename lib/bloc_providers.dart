...
import 'src/domain/usecase/driver-trip-request/index.dart';
...
List<BlocProvider> blocProvider = [
  ...
  BlocProvider<ClientMapBookingInfoBloc> (create: (context) => ClientMapBookingInfoBloc ( locator<GeolocatorUseCases>(),context.read<BlocSocketIO>(), locator<ClientRequestUseCases>(), locator<AuthUseCases>())),
  BlocProvider<DriverClientRequestsBloc> (create: (context) => DriverClientRequestsBloc ( locator<ClientRequestUseCases>(),context.read<BlocSocketIO>(), locator<DriverPositionUseCases>(), locator<AuthUseCases>(), locator<DriverTripRequestUseCases>())),
